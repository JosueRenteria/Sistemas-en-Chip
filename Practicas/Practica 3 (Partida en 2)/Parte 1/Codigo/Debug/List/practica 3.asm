...
; 0000 0035 PORTC=(1<<PORTC7) | (1<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (1<<PORTC3) | (1<<PORTC2) | (1<<PORTC1) | (1<<PORTC0);
	LDI  R30,LOW(255)
	OUT  0x15,R30
; 0000 0036 
...
; 0000 0039 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(0)
	OUT  0x11,R30
; 0000 003A // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 003B PORTD=(1<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 003C 
...
; 0000 0062 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 0063 TCCR2=(0<<WGM20) | (0<<COM21) | (0<<COM20) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
_0x3:
; 0000 008B {
; 0000 008C variable1 = PIND&0x0f; //Enmascaramos los 4 bits menos significativos
	IN   R30,0x10
	ANDI R30,LOW(0xF)
	MOV  R5,R30
; 0000 008D variable2 = PINC&0x0f; //Enmascaramos los 4 bits menos significativos
	IN   R30,0x13
	ANDI R30,LOW(0xF)
	MOV  R4,R30
; 0000 008E //del puerto A ya que los demás no interesan.
; 0000 008F if (variable1<10)
	LDI  R30,LOW(10)
	CP   R5,R30
	BRSH _0x6
; 0000 0090 PORTB = tabla7segmentos[variable1];
	MOV  R30,R5
	LDI  R31,0
	...
	OUT  0x18,R0
; 0000 0091 
; 0000 0092 //del puerto A ya que los demás no interesan.
; 0000 0093 if (variable2<10)
_0x6:
	LDI  R30,LOW(10)
	CP   R4,R30
	BRSH _0x7
; 0000 0094 PORTA = ~tabla7segmentos[variable2];
	MOV  R30,R4
	LDI  R31,0
	SUBI R30,LOW(-_tabla7segmentos*2)
	SBCI R31,HIGH(-_tabla7segmentos*2)
	...
	OUT  0x1B,R30
; 0000 0095 
; 0000 0096 if (variable1>=10) //Si lo que leemos es mayor o igual de 10 que dibuje en el display una E de ERROR
_0x7:
	LDI  R30,LOW(10)
	CP   R5,R30
	BRLO _0x8
; 0000 0097 PORTB = 0x79;
	LDI  R30,LOW(121)
	OUT  0x18,R30
; 0000 0098 
; 0000 0099 if (variable2>=10) //Si lo que leemos es mayor o igual de 10 que dibuje en el display una E de ERROR
_0x8:
	LDI  R30,LOW(10)
	CP   R4,R30
	BRLO _0x9
; 0000 009A PORTA = ~0x79;
	LDI  R30,LOW(134)
	OUT  0x1B,R30
; 0000 009B 
; 0000 009C }

...
const char tabla7segmentos [16]={0x3f,0x06,0x5b,0x4f,0x66,0x6d,0x7c,0x07,0x7f,0x6f,0x77,0x7f,0x39,0x3f,0x79,0x71};
...
while (1)
      ...
      //if (variable1>=16) //Si lo que leemos es mayor o igual de 10 que dibuje en el display una E de ERROR
        //PORTB = 0x79;
      
      //if (variable2>=16) //Si lo que leemos es mayor o igual de 10 que dibuje en el display una E de ERROR
        //PORTA = ~0x79;
      }
}

...
;CodeVisionAVR C Compiler V3.49 
...
; 0000 0036 DDRD=(1<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(255)
	OUT  0x11,R30
; 0000 0037 // State: Bit7=1 Bit6=1 Bit5=1 Bit4=1 Bit3=1 Bit2=1 Bit1=1 Bit0=1
; 0000 0038 PORTD=(1<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	OUT  0x12,R30
; 0000 0039 
...
_0x3:
; 0000 0088 {
; 0000 0089 PORTD--; //incrementa valor de puerto
	IN   R30,0x12
	SUBI R30,LOW(1)
	OUT  0x12,R30
; 0000 008A delay_ms(250); //retardo que se genera para visualizar la información
	LDI  R26,LOW(250)
	LDI  R27,0
	RCALL _delay_ms
; 0000 008B }

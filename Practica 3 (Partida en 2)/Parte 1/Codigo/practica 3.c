...
while (1)
      ...
      if (variable1>=10) //Si lo que leemos es mayor o igual de 10 que dibuje en el display una E de ERROR
        PORTB = 0x79;
      
      if (variable2>=10) //Si lo que leemos es mayor o igual de 10 que dibuje en el display una E de ERROR
        PORTA = ~0x79;
